<?php
	...
	class BootstrapForm {
		...
		public function input($name, $icon = '', $type = 'text', $class = '', $id = '', $value = '', $placeholder = '', $min = '', $max = '', $readonly = '', $required = '' ) {
			...
			if(!empty($readonly)) {
				...
				$input = "<input type ='".$type."' name = '".$name."' value = '".$value."' class = 'form-control has-feedback-left ".$class."' id = '".$id."' placeholder = '".$placeholder."' required = '".$required."' />";
			}else {
